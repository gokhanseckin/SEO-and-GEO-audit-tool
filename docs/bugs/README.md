...
| [BUG-013](BUG-013-silent-fire-and-forget-dispatch.md) | High | Backend / API | Silent fire-and-forget Edge Function dispatch strands audits in `status='running'` when gateway rejects | Fixed in `53504a1` |
